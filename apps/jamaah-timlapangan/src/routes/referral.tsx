...
import { AGEN, JAMAAH, PAKET, formatRupiah } from "@/data/mock";

export const Route = createFileRoute("/referral")({
  head: () => ({
    meta: [
      { title: "Alat Referral Agen — UmrahPro" },
      { name: "description", content: "Link referral, brosur digital, template pesan, dan tracking konversi khusus agen umroh." },
      { property: "og:title", content: "Alat Referral Agen — UmrahPro" },
      { property: "og:description", content: "Bagikan paket, pantau konversi, dan raih bonus level agen." },
    ],
  }),
