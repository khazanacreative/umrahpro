...
import { AGEN, JAMAAH, formatRupiah } from "@umrahpro/shared";

export const Route = createFileRoute("/komisi")({
  head: () => ({
    meta: [
      { title: "Komisi — UmrahPro" },
      { name: "description", content: "Riwayat dan pencairan komisi agen." },
    ],
  }),
...
function KomisiPage() {
  ...
  return (
    <>
      <PageHeader
        title="Komisi"
        description="Perhitungan, riwayat, dan pencairan komisi."
        actions={
          <>
